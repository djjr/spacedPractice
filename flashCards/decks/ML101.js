...
},
{
    ...
    answer: "The optimizer changes the model to improve its predictions. It optimizes (minimizes) the loss function by making changes that improve the model's output.", 
    tags: ["ML101"] 
},
{
